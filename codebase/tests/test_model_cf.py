...
class test_model(unittest.TestCase):
    ...
    def test_train_model(self):
        ...
        train_model(df, user_id_col='user_id', item_id_col='business_id', item_name_col='name_business', evaluate=True)

    def test_evaluate_model(self):
        df = prepare_data(raw=False)
        evaluate_model(df, user_id_col='user_id', item_id_col='business_id', stratify=None)
