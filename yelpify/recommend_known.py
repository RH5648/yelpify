...
DESCRIPTION
    This module provides access to functions that make recommendations to known item or user.

FUNCTIONS
    recommend_known_item(model, interactions, item_id, user_dict, item_dict, topn, show)
        Return the recommended users to an existing item.

    recommend_known_user(model, interactions, user_id, user_dict, item_dict, topn, new_only, threshold, show)
...
def recommend_known_user(model, interactions, user_id, user_dict, item_dict, topn, new_only = False, threshold = 3, show = True):
